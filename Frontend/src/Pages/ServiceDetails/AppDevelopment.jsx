    ...
    const features = [
        {
            ...
            description: 'Native-like performance with smooth animations and rapid response times.'
        },
        {
            icon: Users,
            title: 'User-Centric',
            description: 'Intuitive interfaces designed with the end-user in mind for maximum engagement.'
        },
        {
            icon: Globe,
            title: 'Cross-Platform',
            description: 'Unified codebases that deploy seamlessly to both iOS and Android.'
        },
        {
            icon: Star,
            title: 'Store Ready',
    ...
    const process = [
        {
            step: '01',
            title: 'Strategy',
            description: 'Defining the roadmap and core features of your application.'
        },
        {
            step: '02',
            title: 'Design',
            description: 'Crafting beautiful, functional, and intuitive user interfaces.'
        },
        {
            step: '03',
            title: 'Develop',
        ...
        },
        {
            step: '04',
            title: 'Deploy',
            description: 'Rigorous testing and successful launch to app stores.'
        }
    ];
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        <div className="inline-flex items-center gap-2 bg-white border border-gray-200 px-4 py-2 rounded-full mb-8 shadow-sm">
                            ...
                            <span className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Mobile Solutions</span>
                        </div>
                        ...
                        <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                            We create powerful, intuitive mobile applications that connect your business with customers on the go.
                        </p>
                        <Link
                            to="/contact"
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-20">
                            ...
                            <p className="text-gray-400 max-w-2xl mx-auto">
                                From concept to launch, we handle every step with precision.
                            </p>
                        </div>
            ...
            <section className="py-24 bg-white border-t border-gray-100">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
                        Let's turn your concept into a reality that users will love.
                    </p>
